...
static void glad_gl_load_GL_AMD_debug_output(GLADuserptrloadfunc load,
  ...
  glad_glDebugMessageInsertAMD =
      (PFNGLDEBUGMESSAGEINSERTAMDPROC)load(userptr, "glDebugMessageInsertAMD");
  glad_glGetDebugMessageLogAMD =
      (PFNGLGETDEBUGMESSAGELOGAMDPROC)load(userptr, "glGetDebugMessageLogAMD");
}
...
static void glad_gl_load_GL_AMD_gpu_shader_int64(GLADuserptrloadfunc load,
  ...
  glad_glProgramUniform1i64vNV =
      (PFNGLPROGRAMUNIFORM1I64VNVPROC)load(userptr, "glProgramUniform1i64vNV");
  glad_glProgramUniform1ui64NV =
      (PFNGLPROGRAMUNIFORM1UI64NVPROC)load(userptr, "glProgramUniform1ui64NV");
  ...
  glad_glProgramUniform2i64vNV =
      (PFNGLPROGRAMUNIFORM2I64VNVPROC)load(userptr, "glProgramUniform2i64vNV");
  glad_glProgramUniform2ui64NV =
      (PFNGLPROGRAMUNIFORM2UI64NVPROC)load(userptr, "glProgramUniform2ui64NV");
  ...
  glad_glProgramUniform3i64vNV =
      (PFNGLPROGRAMUNIFORM3I64VNVPROC)load(userptr, "glProgramUniform3i64vNV");
  glad_glProgramUniform3ui64NV =
      (PFNGLPROGRAMUNIFORM3UI64NVPROC)load(userptr, "glProgramUniform3ui64NV");
  ...
  glad_glProgramUniform4i64vNV =
      (PFNGLPROGRAMUNIFORM4I64VNVPROC)load(userptr, "glProgramUniform4i64vNV");
  glad_glProgramUniform4ui64NV =
      (PFNGLPROGRAMUNIFORM4UI64NVPROC)load(userptr, "glProgramUniform4ui64NV");
...
static void glad_gl_load_GL_AMD_multi_draw_indirect(GLADuserptrloadfunc load,
  ...
  if (!GLAD_GL_AMD_multi_draw_indirect)
    return;
  glad_glMultiDrawArraysIndirectAMD = (PFNGLMULTIDRAWARRAYSINDIRECTAMDPROC)load(
...
static void glad_gl_load_GL_AMD_performance_monitor(GLADuserptrloadfunc load,
  ...
  glad_glDeletePerfMonitorsAMD =
      (PFNGLDELETEPERFMONITORSAMDPROC)load(userptr, "glDeletePerfMonitorsAMD");
...
glad_gl_load_GL_AMD_vertex_shader_tessellator(GLADuserptrloadfunc load,
  ...
  glad_glTessellationFactorAMD =
      (PFNGLTESSELLATIONFACTORAMDPROC)load(userptr, "glTessellationFactorAMD");
...
static void glad_gl_load_GL_APPLE_element_array(GLADuserptrloadfunc load,
  ...
  glad_glDrawElementArrayAPPLE =
      (PFNGLDRAWELEMENTARRAYAPPLEPROC)load(userptr, "glDrawElementArrayAPPLE");
  glad_glDrawRangeElementArrayAPPLE = (PFNGLDRAWRANGEELEMENTARRAYAPPLEPROC)load(
  ...
  glad_glMultiDrawElementArrayAPPLE = (PFNGLMULTIDRAWELEMENTARRAYAPPLEPROC)load(
...
static void glad_gl_load_GL_APPLE_flush_buffer_range(GLADuserptrloadfunc load,
  ...
  glad_glBufferParameteriAPPLE =
      (PFNGLBUFFERPARAMETERIAPPLEPROC)load(userptr, "glBufferParameteriAPPLE");
...
static void glad_gl_load_GL_APPLE_vertex_array_range(GLADuserptrloadfunc load,
  ...
  if (!GLAD_GL_APPLE_vertex_array_range)
    return;
  glad_glFlushVertexArrayRangeAPPLE = (PFNGLFLUSHVERTEXARRAYRANGEAPPLEPROC)load(
      userptr, "glFlushVertexArrayRangeAPPLE");
  glad_glVertexArrayParameteriAPPLE = (PFNGLVERTEXARRAYPARAMETERIAPPLEPROC)load(
...
glad_gl_load_GL_APPLE_vertex_program_evaluators(GLADuserptrloadfunc load,
  ...
  glad_glIsVertexAttribEnabledAPPLE = (PFNGLISVERTEXATTRIBENABLEDAPPLEPROC)load(
...
static void glad_gl_load_GL_ARB_bindless_texture(GLADuserptrloadfunc load,
  ...
  glad_glGetTextureSamplerHandleARB = (PFNGLGETTEXTURESAMPLERHANDLEARBPROC)load(
  ...
  glad_glIsTextureHandleResidentARB = (PFNGLISTEXTUREHANDLERESIDENTARBPROC)load(
  ...
  glad_glMakeImageHandleResidentARB = (PFNGLMAKEIMAGEHANDLERESIDENTARBPROC)load(
...
static void glad_gl_load_GL_ARB_matrix_palette(GLADuserptrloadfunc load,
  ...
  glad_glMatrixIndexPointerARB =
      (PFNGLMATRIXINDEXPOINTERARBPROC)load(userptr, "glMatrixIndexPointerARB");
...
static void glad_gl_load_GL_ATI_envmap_bumpmap(GLADuserptrloadfunc load,
  ...
  glad_glTexBumpParameterfvATI =
      (PFNGLTEXBUMPPARAMETERFVATIPROC)load(userptr, "glTexBumpParameterfvATI");
  glad_glTexBumpParameterivATI =
      (PFNGLTEXBUMPPARAMETERIVATIPROC)load(userptr, "glTexBumpParameterivATI");
}
static void glad_gl_load_GL_ATI_fragment_shader(GLADuserptrloadfunc load,
  ...
  glad_glBindFragmentShaderATI =
      (PFNGLBINDFRAGMENTSHADERATIPROC)load(userptr, "glBindFragmentShaderATI");
  ...
  glad_glGenFragmentShadersATI =
      (PFNGLGENFRAGMENTSHADERSATIPROC)load(userptr, "glGenFragmentShadersATI");
...
static void glad_gl_load_GL_ATI_vertex_array_object(GLADuserptrloadfunc load,
  ...
  glad_glGetVariantArrayObjectfvATI = (PFNGLGETVARIANTARRAYOBJECTFVATIPROC)load(
      userptr, "glGetVariantArrayObjectfvATI");
  glad_glGetVariantArrayObjectivATI = (PFNGLGETVARIANTARRAYOBJECTIVATIPROC)load(
  ...
  glad_glUpdateObjectBufferATI =
      (PFNGLUPDATEOBJECTBUFFERATIPROC)load(userptr, "glUpdateObjectBufferATI");
  glad_glVariantArrayObjectATI =
      (PFNGLVARIANTARRAYOBJECTATIPROC)load(userptr, "glVariantArrayObjectATI");
}
static void
...
static void glad_gl_load_GL_EXT_convolution(GLADuserptrloadfunc load,
  ...
  glad_glCopyConvolutionFilter1DEXT = (PFNGLCOPYCONVOLUTIONFILTER1DEXTPROC)load(
      userptr, "glCopyConvolutionFilter1DEXT");
  glad_glCopyConvolutionFilter2DEXT = (PFNGLCOPYCONVOLUTIONFILTER2DEXTPROC)load(
  ...
  glad_glGetSeparableFilterEXT =
      (PFNGLGETSEPARABLEFILTEREXTPROC)load(userptr, "glGetSeparableFilterEXT");
...
static void glad_gl_load_GL_EXT_direct_state_access(GLADuserptrloadfunc load,
  ...
  glad_glClearNamedBufferSubDataEXT = (PFNGLCLEARNAMEDBUFFERSUBDATAEXTPROC)load(
  ...
  glad_glCopyTextureImage1DEXT =
      (PFNGLCOPYTEXTUREIMAGE1DEXTPROC)load(userptr, "glCopyTextureImage1DEXT");
  glad_glCopyTextureImage2DEXT =
      (PFNGLCOPYTEXTUREIMAGE2DEXTPROC)load(userptr, "glCopyTextureImage2DEXT");
  ...
  glad_glDisableVertexArrayEXT =
      (PFNGLDISABLEVERTEXARRAYEXTPROC)load(userptr, "glDisableVertexArrayEXT");
  ...
  glad_glEnableClientStateiEXT =
      (PFNGLENABLECLIENTSTATEIEXTPROC)load(userptr, "glEnableClientStateiEXT");
  glad_glEnableIndexedEXT =
      (PFNGLENABLEINDEXEDEXTPROC)load(userptr, "glEnableIndexedEXT");
  glad_glEnableVertexArrayAttribEXT = (PFNGLENABLEVERTEXARRAYATTRIBEXTPROC)load(
  ...
  glad_glGetMultiTexParameterIivEXT = (PFNGLGETMULTITEXPARAMETERIIVEXTPROC)load(
  ...
  glad_glGetPointerIndexedvEXT =
      (PFNGLGETPOINTERINDEXEDVEXTPROC)load(userptr, "glGetPointerIndexedvEXT");
  ...
  glad_glGetTextureParameterIuivEXT = (PFNGLGETTEXTUREPARAMETERIUIVEXTPROC)load(
  ...
  glad_glMatrixLoadIdentityEXT =
      (PFNGLMATRIXLOADIDENTITYEXTPROC)load(userptr, "glMatrixLoadIdentityEXT");
  ...
  glad_glMultiTexParameterfEXT =
      (PFNGLMULTITEXPARAMETERFEXTPROC)load(userptr, "glMultiTexParameterfEXT");
  ...
  glad_glMultiTexParameteriEXT =
      (PFNGLMULTITEXPARAMETERIEXTPROC)load(userptr, "glMultiTexParameteriEXT");
  ...
  glad_glMultiTexSubImage1DEXT =
      (PFNGLMULTITEXSUBIMAGE1DEXTPROC)load(userptr, "glMultiTexSubImage1DEXT");
  glad_glMultiTexSubImage2DEXT =
      (PFNGLMULTITEXSUBIMAGE2DEXTPROC)load(userptr, "glMultiTexSubImage2DEXT");
  glad_glMultiTexSubImage3DEXT =
      (PFNGLMULTITEXSUBIMAGE3DEXTPROC)load(userptr, "glMultiTexSubImage3DEXT");
  glad_glNamedBufferDataEXT =
      (PFNGLNAMEDBUFFERDATAEXTPROC)load(userptr, "glNamedBufferDataEXT");
  glad_glNamedBufferStorageEXT =
      (PFNGLNAMEDBUFFERSTORAGEEXTPROC)load(userptr, "glNamedBufferStorageEXT");
  glad_glNamedBufferSubDataEXT =
      (PFNGLNAMEDBUFFERSUBDATAEXTPROC)load(userptr, "glNamedBufferSubDataEXT");
  ...
  glad_glNamedFramebufferTextureEXT = (PFNGLNAMEDFRAMEBUFFERTEXTUREEXTPROC)load(
  ...
  glad_glNamedProgramStringEXT =
      (PFNGLNAMEDPROGRAMSTRINGEXTPROC)load(userptr, "glNamedProgramStringEXT");
  ...
  glad_glProgramUniform1uivEXT =
      (PFNGLPROGRAMUNIFORM1UIVEXTPROC)load(userptr, "glProgramUniform1uivEXT");
  ...
  glad_glProgramUniform2uivEXT =
      (PFNGLPROGRAMUNIFORM2UIVEXTPROC)load(userptr, "glProgramUniform2uivEXT");
  ...
  glad_glProgramUniform3uivEXT =
      (PFNGLPROGRAMUNIFORM3UIVEXTPROC)load(userptr, "glProgramUniform3uivEXT");
  ...
  glad_glProgramUniform4uivEXT =
      (PFNGLPROGRAMUNIFORM4UIVEXTPROC)load(userptr, "glProgramUniform4uivEXT");
  glad_glProgramUniformMatrix2dvEXT = (PFNGLPROGRAMUNIFORMMATRIX2DVEXTPROC)load(
      userptr, "glProgramUniformMatrix2dvEXT");
  glad_glProgramUniformMatrix2fvEXT = (PFNGLPROGRAMUNIFORMMATRIX2FVEXTPROC)load(
  ...
  glad_glProgramUniformMatrix3dvEXT = (PFNGLPROGRAMUNIFORMMATRIX3DVEXTPROC)load(
      userptr, "glProgramUniformMatrix3dvEXT");
  glad_glProgramUniformMatrix3fvEXT = (PFNGLPROGRAMUNIFORMMATRIX3FVEXTPROC)load(
  ...
  glad_glProgramUniformMatrix4dvEXT = (PFNGLPROGRAMUNIFORMMATRIX4DVEXTPROC)load(
      userptr, "glProgramUniformMatrix4dvEXT");
  glad_glProgramUniformMatrix4fvEXT = (PFNGLPROGRAMUNIFORMMATRIX4FVEXTPROC)load(
  ...
  glad_glPushClientAttribDefaultEXT = (PFNGLPUSHCLIENTATTRIBDEFAULTEXTPROC)load(
  ...
  glad_glTextureBufferRangeEXT =
      (PFNGLTEXTUREBUFFERRANGEEXTPROC)load(userptr, "glTextureBufferRangeEXT");
  ...
  glad_glTextureParameterfvEXT =
      (PFNGLTEXTUREPARAMETERFVEXTPROC)load(userptr, "glTextureParameterfvEXT");
  glad_glTextureParameteriEXT =
      (PFNGLTEXTUREPARAMETERIEXTPROC)load(userptr, "glTextureParameteriEXT");
  glad_glTextureParameterivEXT =
      (PFNGLTEXTUREPARAMETERIVEXTPROC)load(userptr, "glTextureParameterivEXT");
  ...
  glad_glVertexArrayNormalOffsetEXT = (PFNGLVERTEXARRAYNORMALOFFSETEXTPROC)load(
  ...
  glad_glVertexArrayVertexOffsetEXT = (PFNGLVERTEXARRAYVERTEXOFFSETEXTPROC)load(
...
static void glad_gl_load_GL_EXT_fragment_shading_rate(GLADuserptrloadfunc load,
                                                      void *userptr) {
  if (!GLAD_GL_EXT_fragment_shading_rate)
    return;
  glad_glFramebufferShadingRateEXT = (PFNGLFRAMEBUFFERSHADINGRATEEXTPROC)load(
      userptr, "glFramebufferShadingRateEXT");
  glad_glGetFragmentShadingRatesEXT = (PFNGLGETFRAGMENTSHADINGRATESEXTPROC)load(
      userptr, "glGetFragmentShadingRatesEXT");
  glad_glShadingRateCombinerOpsEXT = (PFNGLSHADINGRATECOMBINEROPSEXTPROC)load(
      userptr, "glShadingRateCombinerOpsEXT");
  glad_glShadingRateEXT =
...
static void
glad_gl_load_GL_EXT_framebuffer_blit_layers(GLADuserptrloadfunc load,
                                            void *userptr) {
  if (!GLAD_GL_EXT_framebuffer_blit_layers)
    return;
  glad_glBlitFramebufferLayerEXT = (PFNGLBLITFRAMEBUFFERLAYEREXTPROC)load(
      userptr, "glBlitFramebufferLayerEXT");
  glad_glBlitFramebufferLayersEXT = (PFNGLBLITFRAMEBUFFERLAYERSEXTPROC)load(
...
static void glad_gl_load_GL_EXT_gpu_program_parameters(GLADuserptrloadfunc load,
  ...
  if (!GLAD_GL_EXT_gpu_program_parameters)
    return;
  glad_glProgramEnvParameters4fvEXT = (PFNGLPROGRAMENVPARAMETERS4FVEXTPROC)load(
...
static void glad_gl_load_GL_EXT_gpu_shader4(GLADuserptrloadfunc load,
  ...
  glad_glGetVertexAttribIivEXT =
      (PFNGLGETVERTEXATTRIBIIVEXTPROC)load(userptr, "glGetVertexAttribIivEXT");
...
static void glad_gl_load_GL_EXT_histogram(GLADuserptrloadfunc load,
  ...
  glad_glGetHistogramParameterfvEXT = (PFNGLGETHISTOGRAMPARAMETERFVEXTPROC)load(
      userptr, "glGetHistogramParameterfvEXT");
  glad_glGetHistogramParameterivEXT = (PFNGLGETHISTOGRAMPARAMETERIVEXTPROC)load(
...
static void glad_gl_load_GL_EXT_memory_object(GLADuserptrloadfunc load,
  ...
  glad_glMemoryObjectParameterivEXT = (PFNGLMEMORYOBJECTPARAMETERIVEXTPROC)load(
...
static void glad_gl_load_GL_EXT_memory_object_win32(GLADuserptrloadfunc load,
  ...
  if (!GLAD_GL_EXT_memory_object_win32)
    return;
  glad_glImportMemoryWin32HandleEXT = (PFNGLIMPORTMEMORYWIN32HANDLEEXTPROC)load(
...
static void glad_gl_load_GL_EXT_mesh_shader(GLADuserptrloadfunc load,
                                            void *userptr) {
  if (!GLAD_GL_EXT_mesh_shader)
    return;
  glad_glDrawMeshTasksEXT =
      (PFNGLDRAWMESHTASKSEXTPROC)load(userptr, "glDrawMeshTasksEXT");
  glad_glDrawMeshTasksIndirectEXT = (PFNGLDRAWMESHTASKSINDIRECTEXTPROC)load(
...
static void glad_gl_load_GL_EXT_polygon_offset_clamp(GLADuserptrloadfunc load,
  ...
  glad_glPolygonOffsetClampEXT =
      (PFNGLPOLYGONOFFSETCLAMPEXTPROC)load(userptr, "glPolygonOffsetClampEXT");
}
...
static void glad_gl_load_GL_EXT_semaphore(GLADuserptrloadfunc load,
  ...
  glad_glSemaphoreParameterui64vEXT = (PFNGLSEMAPHOREPARAMETERUI64VEXTPROC)load(
...
static void glad_gl_load_GL_EXT_shader_framebuffer_fetch_non_coherent(
  ...
  if (!GLAD_GL_EXT_shader_framebuffer_fetch_non_coherent)
    return;
  glad_glFramebufferFetchBarrierEXT = (PFNGLFRAMEBUFFERFETCHBARRIEREXTPROC)load(
...
static void glad_gl_load_GL_EXT_texture_array(GLADuserptrloadfunc load,
  ...
  if (!GLAD_GL_EXT_texture_array)
    return;
  glad_glFramebufferTextureLayerEXT = (PFNGLFRAMEBUFFERTEXTURELAYEREXTPROC)load(
...
static void glad_gl_load_GL_EXT_texture_integer(GLADuserptrloadfunc load,
  ...
  glad_glGetTexParameterIivEXT =
      (PFNGLGETTEXPARAMETERIIVEXTPROC)load(userptr, "glGetTexParameterIivEXT");
...
static void glad_gl_load_GL_EXT_timer_query(GLADuserptrloadfunc load,
  ...
  glad_glGetQueryObjecti64vEXT =
      (PFNGLGETQUERYOBJECTI64VEXTPROC)load(userptr, "glGetQueryObjecti64vEXT");
...
static void glad_gl_load_GL_EXT_vertex_attrib_64bit(GLADuserptrloadfunc load,
  ...
  glad_glGetVertexAttribLdvEXT =
      (PFNGLGETVERTEXATTRIBLDVEXTPROC)load(userptr, "glGetVertexAttribLdvEXT");
...
static void glad_gl_load_GL_EXT_vertex_shader(GLADuserptrloadfunc load,
  ...
  glad_glBindLightParameterEXT =
      (PFNGLBINDLIGHTPARAMETEREXTPROC)load(userptr, "glBindLightParameterEXT");
  ...
  glad_glDeleteVertexShaderEXT =
      (PFNGLDELETEVERTEXSHADEREXTPROC)load(userptr, "glDeleteVertexShaderEXT");
  ...
  glad_glGetInvariantFloatvEXT =
      (PFNGLGETINVARIANTFLOATVEXTPROC)load(userptr, "glGetInvariantFloatvEXT");
  ...
  glad_glGetVariantBooleanvEXT =
      (PFNGLGETVARIANTBOOLEANVEXTPROC)load(userptr, "glGetVariantBooleanvEXT");
  glad_glGetVariantFloatvEXT =
      (PFNGLGETVARIANTFLOATVEXTPROC)load(userptr, "glGetVariantFloatvEXT");
  glad_glGetVariantIntegervEXT =
      (PFNGLGETVARIANTINTEGERVEXTPROC)load(userptr, "glGetVariantIntegervEXT");
  glad_glGetVariantPointervEXT =
      (PFNGLGETVARIANTPOINTERVEXTPROC)load(userptr, "glGetVariantPointervEXT");
...
static void glad_gl_load_GL_HP_image_transform(GLADuserptrloadfunc load,
  ...
  glad_glImageTransformParameterfHP = (PFNGLIMAGETRANSFORMPARAMETERFHPPROC)load(
  ...
  glad_glImageTransformParameteriHP = (PFNGLIMAGETRANSFORMPARAMETERIHPPROC)load(
...
static void glad_gl_load_GL_INGR_blend_func_separate(GLADuserptrloadfunc load,
  ...
  glad_glBlendFuncSeparateINGR =
      (PFNGLBLENDFUNCSEPARATEINGRPROC)load(userptr, "glBlendFuncSeparateINGR");
}
...
static void glad_gl_load_GL_INTEL_parallel_arrays(GLADuserptrloadfunc load,
  ...
  glad_glTexCoordPointervINTEL =
      (PFNGLTEXCOORDPOINTERVINTELPROC)load(userptr, "glTexCoordPointervINTEL");
...
static void glad_gl_load_GL_INTEL_performance_query(GLADuserptrloadfunc load,
  ...
  glad_glGetPerfQueryDataINTEL =
      (PFNGLGETPERFQUERYDATAINTELPROC)load(userptr, "glGetPerfQueryDataINTEL");
  ...
  glad_glGetPerfQueryInfoINTEL =
      (PFNGLGETPERFQUERYINFOINTELPROC)load(userptr, "glGetPerfQueryInfoINTEL");
}
static void
...
static void glad_gl_load_GL_NVX_gpu_multicast2(GLADuserptrloadfunc load,
  ...
  glad_glMulticastViewportArrayvNVX = (PFNGLMULTICASTVIEWPORTARRAYVNVXPROC)load(
...
static void glad_gl_load_GL_NVX_progress_fence(GLADuserptrloadfunc load,
  ...
  if (!GLAD_GL_NVX_progress_fence)
    return;
  glad_glClientWaitSemaphoreui64NVX = (PFNGLCLIENTWAITSEMAPHOREUI64NVXPROC)load(
...
static void glad_gl_load_GL_NV_bindless_texture(GLADuserptrloadfunc load,
  ...
  glad_glProgramUniformHandleui64NV = (PFNGLPROGRAMUNIFORMHANDLEUI64NVPROC)load(
...
static void glad_gl_load_GL_NV_command_list(GLADuserptrloadfunc load,
  ...
  glad_glCommandListSegmentsNV =
      (PFNGLCOMMANDLISTSEGMENTSNVPROC)load(userptr, "glCommandListSegmentsNV");
...
static void glad_gl_load_GL_NV_evaluators(GLADuserptrloadfunc load,
  ...
  glad_glGetMapControlPointsNV =
      (PFNGLGETMAPCONTROLPOINTSNVPROC)load(userptr, "glGetMapControlPointsNV");
...
static void glad_gl_load_GL_NV_fragment_program(GLADuserptrloadfunc load,
  ...
  glad_glProgramNamedParameter4dvNV = (PFNGLPROGRAMNAMEDPARAMETER4DVNVPROC)load(
  ...
  glad_glProgramNamedParameter4fvNV = (PFNGLPROGRAMNAMEDPARAMETER4FVNVPROC)load(
...
static void glad_gl_load_GL_NV_geometry_program4(GLADuserptrloadfunc load,
  ...
  glad_glFramebufferTextureEXT =
      (PFNGLFRAMEBUFFERTEXTUREEXTPROC)load(userptr, "glFramebufferTextureEXT");
...
static void glad_gl_load_GL_NV_gpu_multicast(GLADuserptrloadfunc load,
  ...
  glad_glMulticastBlitFramebufferNV = (PFNGLMULTICASTBLITFRAMEBUFFERNVPROC)load(
...
static void glad_gl_load_GL_NV_gpu_program4(GLADuserptrloadfunc load,
  ...
  glad_glProgramEnvParameterI4uivNV = (PFNGLPROGRAMENVPARAMETERI4UIVNVPROC)load(
      userptr, "glProgramEnvParameterI4uivNV");
  glad_glProgramEnvParametersI4ivNV = (PFNGLPROGRAMENVPARAMETERSI4IVNVPROC)load(
  ...
  glad_glProgramLocalParameterI4iNV = (PFNGLPROGRAMLOCALPARAMETERI4INVPROC)load(
...
static void glad_gl_load_GL_NV_memory_attachment(GLADuserptrloadfunc load,
  ...
  glad_glTextureAttachMemoryNV =
      (PFNGLTEXTUREATTACHMEMORYNVPROC)load(userptr, "glTextureAttachMemoryNV");
}
static void glad_gl_load_GL_NV_memory_object_sparse(GLADuserptrloadfunc load,
  ...
  glad_glTexturePageCommitmentMemNV = (PFNGLTEXTUREPAGECOMMITMENTMEMNVPROC)load(
...
static void glad_gl_load_GL_NV_occlusion_query(GLADuserptrloadfunc load,
  ...
  glad_glBeginOcclusionQueryNV =
      (PFNGLBEGINOCCLUSIONQUERYNVPROC)load(userptr, "glBeginOcclusionQueryNV");
  ...
  glad_glGenOcclusionQueriesNV =
      (PFNGLGENOCCLUSIONQUERIESNVPROC)load(userptr, "glGenOcclusionQueriesNV");
  glad_glGetOcclusionQueryivNV =
      (PFNGLGETOCCLUSIONQUERYIVNVPROC)load(userptr, "glGetOcclusionQueryivNV");
...
static void glad_gl_load_GL_NV_path_rendering(GLADuserptrloadfunc load,
  ...
  glad_glCoverStrokePathInstancedNV = (PFNGLCOVERSTROKEPATHINSTANCEDNVPROC)load(
  ...
  glad_glIsPointInStrokePathNV =
      (PFNGLISPOINTINSTROKEPATHNVPROC)load(userptr, "glIsPointInStrokePathNV");
  glad_glMatrixFrustumEXT =
      (PFNGLMATRIXFRUSTUMEXTPROC)load(userptr, "glMatrixFrustumEXT");
  ...
  glad_glPathGlyphIndexRangeNV =
      (PFNGLPATHGLYPHINDEXRANGENVPROC)load(userptr, "glPathGlyphIndexRangeNV");
  ...
  glad_glStencilFillPathInstancedNV = (PFNGLSTENCILFILLPATHINSTANCEDNVPROC)load(
  ...
  glad_glStencilThenCoverFillPathNV = (PFNGLSTENCILTHENCOVERFILLPATHNVPROC)load(
...
static void glad_gl_load_GL_NV_pixel_data_range(GLADuserptrloadfunc load,
  ...
  glad_glFlushPixelDataRangeNV =
      (PFNGLFLUSHPIXELDATARANGENVPROC)load(userptr, "glFlushPixelDataRangeNV");
...
static void glad_gl_load_GL_NV_query_resource_tag(GLADuserptrloadfunc load,
  ...
  glad_glGenQueryResourceTagNV =
      (PFNGLGENQUERYRESOURCETAGNVPROC)load(userptr, "glGenQueryResourceTagNV");
...
static void glad_gl_load_GL_NV_register_combiners(GLADuserptrloadfunc load,
  ...
  glad_glCombinerParameterivNV =
      (PFNGLCOMBINERPARAMETERIVNVPROC)load(userptr, "glCombinerParameterivNV");
...
static void glad_gl_load_GL_NV_register_combiners2(GLADuserptrloadfunc load,
  ...
  if (!GLAD_GL_NV_register_combiners2)
    return;
  glad_glCombinerStageParameterfvNV = (PFNGLCOMBINERSTAGEPARAMETERFVNVPROC)load(
...
static void glad_gl_load_GL_NV_shader_buffer_load(GLADuserptrloadfunc load,
  ...
  glad_glProgramUniformui64vNV =
      (PFNGLPROGRAMUNIFORMUI64VNVPROC)load(userptr, "glProgramUniformui64vNV");
...
static void glad_gl_load_GL_NV_transform_feedback(GLADuserptrloadfunc load,
  ...
  glad_glTransformFeedbackAttribsNV = (PFNGLTRANSFORMFEEDBACKATTRIBSNVPROC)load(
...
static void glad_gl_load_GL_NV_transform_feedback2(GLADuserptrloadfunc load,
  ...
  glad_glDeleteTransformFeedbacksNV = (PFNGLDELETETRANSFORMFEEDBACKSNVPROC)load(
  ...
  glad_glIsTransformFeedbackNV =
      (PFNGLISTRANSFORMFEEDBACKNVPROC)load(userptr, "glIsTransformFeedbackNV");
...
glad_gl_load_GL_NV_vertex_attrib_integer_64bit(GLADuserptrloadfunc load,
  ...
  glad_glVertexAttribL1ui64vNV =
      (PFNGLVERTEXATTRIBL1UI64VNVPROC)load(userptr, "glVertexAttribL1ui64vNV");
  ...
  glad_glVertexAttribL2ui64vNV =
      (PFNGLVERTEXATTRIBL2UI64VNVPROC)load(userptr, "glVertexAttribL2ui64vNV");
  ...
  glad_glVertexAttribL3ui64vNV =
      (PFNGLVERTEXATTRIBL3UI64VNVPROC)load(userptr, "glVertexAttribL3ui64vNV");
  ...
  glad_glVertexAttribL4ui64vNV =
      (PFNGLVERTEXATTRIBL4UI64VNVPROC)load(userptr, "glVertexAttribL4ui64vNV");
  glad_glVertexAttribLFormatNV =
      (PFNGLVERTEXATTRIBLFORMATNVPROC)load(userptr, "glVertexAttribLFormatNV");
}
static void
glad_gl_load_GL_NV_vertex_buffer_unified_memory(GLADuserptrloadfunc load,
  ...
  glad_glVertexAttribIFormatNV =
      (PFNGLVERTEXATTRIBIFORMATNVPROC)load(userptr, "glVertexAttribIFormatNV");
...
static void glad_gl_load_GL_NV_vertex_program(GLADuserptrloadfunc load,
  ...
  glad_glAreProgramsResidentNV =
      (PFNGLAREPROGRAMSRESIDENTNVPROC)load(userptr, "glAreProgramsResidentNV");
  ...
  glad_glProgramParameter4dvNV =
      (PFNGLPROGRAMPARAMETER4DVNVPROC)load(userptr, "glProgramParameter4dvNV");
  glad_glProgramParameter4fNV =
      (PFNGLPROGRAMPARAMETER4FNVPROC)load(userptr, "glProgramParameter4fNV");
  glad_glProgramParameter4fvNV =
      (PFNGLPROGRAMPARAMETER4FVNVPROC)load(userptr, "glProgramParameter4fvNV");
  ...
  glad_glVertexAttribPointerNV =
      (PFNGLVERTEXATTRIBPOINTERNVPROC)load(userptr, "glVertexAttribPointerNV");
...
static void glad_gl_load_GL_SGIS_pixel_texture(GLADuserptrloadfunc load,
  ...
  glad_glPixelTexGenParameterfvSGIS = (PFNGLPIXELTEXGENPARAMETERFVSGISPROC)load(
  ...
  glad_glPixelTexGenParameterivSGIS = (PFNGLPIXELTEXGENPARAMETERIVSGISPROC)load(
...
static void glad_gl_load_GL_SGIS_sharpen_texture(GLADuserptrloadfunc load,
  ...
  glad_glGetSharpenTexFuncSGIS =
      (PFNGLGETSHARPENTEXFUNCSGISPROC)load(userptr, "glGetSharpenTexFuncSGIS");
...
static void glad_gl_load_GL_SGIX_fragment_lighting(GLADuserptrloadfunc load,
  ...
  glad_glFragmentMaterialfSGIX =
      (PFNGLFRAGMENTMATERIALFSGIXPROC)load(userptr, "glFragmentMaterialfSGIX");
  ...
  glad_glFragmentMaterialiSGIX =
      (PFNGLFRAGMENTMATERIALISGIXPROC)load(userptr, "glFragmentMaterialiSGIX");
...
static void glad_gl_load_GL_SGIX_instruments(GLADuserptrloadfunc load,
  ...
  glad_glInstrumentsBufferSGIX =
      (PFNGLINSTRUMENTSBUFFERSGIXPROC)load(userptr, "glInstrumentsBufferSGIX");
...
static void glad_gl_load_GL_SGIX_sprite(GLADuserptrloadfunc load,
  ...
  glad_glSpriteParameterfvSGIX =
      (PFNGLSPRITEPARAMETERFVSGIXPROC)load(userptr, "glSpriteParameterfvSGIX");
  glad_glSpriteParameteriSGIX =
      (PFNGLSPRITEPARAMETERISGIXPROC)load(userptr, "glSpriteParameteriSGIX");
  glad_glSpriteParameterivSGIX =
      (PFNGLSPRITEPARAMETERIVSGIXPROC)load(userptr, "glSpriteParameterivSGIX");
}
...
static void glad_gl_load_GL_SUN_global_alpha(GLADuserptrloadfunc load,
  ...
  glad_glGlobalAlphaFactorbSUN =
      (PFNGLGLOBALALPHAFACTORBSUNPROC)load(userptr, "glGlobalAlphaFactorbSUN");
  glad_glGlobalAlphaFactordSUN =
      (PFNGLGLOBALALPHAFACTORDSUNPROC)load(userptr, "glGlobalAlphaFactordSUN");
  glad_glGlobalAlphaFactorfSUN =
      (PFNGLGLOBALALPHAFACTORFSUNPROC)load(userptr, "glGlobalAlphaFactorfSUN");
  glad_glGlobalAlphaFactoriSUN =
      (PFNGLGLOBALALPHAFACTORISUNPROC)load(userptr, "glGlobalAlphaFactoriSUN");
  glad_glGlobalAlphaFactorsSUN =
      (PFNGLGLOBALALPHAFACTORSSUNPROC)load(userptr, "glGlobalAlphaFactorsSUN");
...
static void glad_gl_load_GL_SUN_triangle_list(GLADuserptrloadfunc load,
  ...
  glad_glReplacementCodeubvSUN =
      (PFNGLREPLACEMENTCODEUBVSUNPROC)load(userptr, "glReplacementCodeubvSUN");
  ...
  glad_glReplacementCodeusvSUN =
      (PFNGLREPLACEMENTCODEUSVSUNPROC)load(userptr, "glReplacementCodeusvSUN");
}
static void glad_gl_load_GL_SUN_vertex(GLADuserptrloadfunc load,
  ...
  glad_glColor4fNormal3fVertex3fSUN = (PFNGLCOLOR4FNORMAL3FVERTEX3FSUNPROC)load(
  ...
  glad_glTexCoord2fVertex3fSUN =
      (PFNGLTEXCOORD2FVERTEX3FSUNPROC)load(userptr, "glTexCoord2fVertex3fSUN");
  ...
  glad_glTexCoord4fVertex4fSUN =
      (PFNGLTEXCOORD4FVERTEX4FSUNPROC)load(userptr, "glTexCoord4fVertex4fSUN");
...
static int glad_gl_find_extensions_gl(void) {
  ...
  GLAD_GL_3DFX_multisample =
      glad_gl_has_extension(exts, exts_i, "GL_3DFX_multisample");
  GLAD_GL_3DFX_tbuffer = glad_gl_has_extension(exts, exts_i, "GL_3DFX_tbuffer");
  GLAD_GL_3DFX_texture_compression_FXT1 =
      glad_gl_has_extension(exts, exts_i, "GL_3DFX_texture_compression_FXT1");
  GLAD_GL_AMD_blend_minmax_factor =
      glad_gl_has_extension(exts, exts_i, "GL_AMD_blend_minmax_factor");
  GLAD_GL_AMD_conservative_depth =
      glad_gl_has_extension(exts, exts_i, "GL_AMD_conservative_depth");
  GLAD_GL_AMD_debug_output =
      glad_gl_has_extension(exts, exts_i, "GL_AMD_debug_output");
  GLAD_GL_AMD_depth_clamp_separate =
      glad_gl_has_extension(exts, exts_i, "GL_AMD_depth_clamp_separate");
  GLAD_GL_AMD_draw_buffers_blend =
      glad_gl_has_extension(exts, exts_i, "GL_AMD_draw_buffers_blend");
  GLAD_GL_AMD_framebuffer_multisample_advanced = glad_gl_has_extension(
      exts, exts_i, "GL_AMD_framebuffer_multisample_advanced");
  GLAD_GL_AMD_framebuffer_sample_positions = glad_gl_has_extension(
  ...
  GLAD_GL_AMD_gpu_shader_half_float =
      glad_gl_has_extension(exts, exts_i, "GL_AMD_gpu_shader_half_float");
  GLAD_GL_AMD_gpu_shader_int16 =
      glad_gl_has_extension(exts, exts_i, "GL_AMD_gpu_shader_int16");
  GLAD_GL_AMD_gpu_shader_int64 =
      glad_gl_has_extension(exts, exts_i, "GL_AMD_gpu_shader_int64");
  GLAD_GL_AMD_interleaved_elements =
      glad_gl_has_extension(exts, exts_i, "GL_AMD_interleaved_elements");
  GLAD_GL_AMD_multi_draw_indirect =
      glad_gl_has_extension(exts, exts_i, "GL_AMD_multi_draw_indirect");
  GLAD_GL_AMD_name_gen_delete =
      glad_gl_has_extension(exts, exts_i, "GL_AMD_name_gen_delete");
  GLAD_GL_AMD_occlusion_query_event =
      glad_gl_has_extension(exts, exts_i, "GL_AMD_occlusion_query_event");
  GLAD_GL_AMD_performance_monitor =
      glad_gl_has_extension(exts, exts_i, "GL_AMD_performance_monitor");
  GLAD_GL_AMD_pinned_memory =
      glad_gl_has_extension(exts, exts_i, "GL_AMD_pinned_memory");
  GLAD_GL_AMD_query_buffer_object =
      glad_gl_has_extension(exts, exts_i, "GL_AMD_query_buffer_object");
  GLAD_GL_AMD_sample_positions =
      glad_gl_has_extension(exts, exts_i, "GL_AMD_sample_positions");
  GLAD_GL_AMD_seamless_cubemap_per_texture = glad_gl_has_extension(
      exts, exts_i, "GL_AMD_seamless_cubemap_per_texture");
  GLAD_GL_AMD_shader_atomic_counter_ops =
      glad_gl_has_extension(exts, exts_i, "GL_AMD_shader_atomic_counter_ops");
  GLAD_GL_AMD_shader_ballot =
      glad_gl_has_extension(exts, exts_i, "GL_AMD_shader_ballot");
  GLAD_GL_AMD_shader_explicit_vertex_parameter = glad_gl_has_extension(
      exts, exts_i, "GL_AMD_shader_explicit_vertex_parameter");
  GLAD_GL_AMD_shader_gpu_shader_half_float_fetch = glad_gl_has_extension(
      exts, exts_i, "GL_AMD_shader_gpu_shader_half_float_fetch");
  GLAD_GL_AMD_shader_image_load_store_lod =
      glad_gl_has_extension(exts, exts_i, "GL_AMD_shader_image_load_store_lod");
  GLAD_GL_AMD_shader_stencil_export =
      glad_gl_has_extension(exts, exts_i, "GL_AMD_shader_stencil_export");
  GLAD_GL_AMD_shader_trinary_minmax =
      glad_gl_has_extension(exts, exts_i, "GL_AMD_shader_trinary_minmax");
  GLAD_GL_AMD_sparse_texture =
      glad_gl_has_extension(exts, exts_i, "GL_AMD_sparse_texture");
  GLAD_GL_AMD_stencil_operation_extended =
      glad_gl_has_extension(exts, exts_i, "GL_AMD_stencil_operation_extended");
  GLAD_GL_AMD_texture_gather_bias_lod =
      glad_gl_has_extension(exts, exts_i, "GL_AMD_texture_gather_bias_lod");
  GLAD_GL_AMD_texture_texture4 =
      glad_gl_has_extension(exts, exts_i, "GL_AMD_texture_texture4");
  GLAD_GL_AMD_transform_feedback3_lines_triangles = glad_gl_has_extension(
      exts, exts_i, "GL_AMD_transform_feedback3_lines_triangles");
  GLAD_GL_AMD_transform_feedback4 =
      glad_gl_has_extension(exts, exts_i, "GL_AMD_transform_feedback4");
  GLAD_GL_AMD_vertex_shader_layer =
      glad_gl_has_extension(exts, exts_i, "GL_AMD_vertex_shader_layer");
  GLAD_GL_AMD_vertex_shader_tessellator =
      glad_gl_has_extension(exts, exts_i, "GL_AMD_vertex_shader_tessellator");
  GLAD_GL_AMD_vertex_shader_viewport_index = glad_gl_has_extension(
      exts, exts_i, "GL_AMD_vertex_shader_viewport_index");
  GLAD_GL_APPLE_aux_depth_stencil =
      glad_gl_has_extension(exts, exts_i, "GL_APPLE_aux_depth_stencil");
  GLAD_GL_APPLE_client_storage =
      glad_gl_has_extension(exts, exts_i, "GL_APPLE_client_storage");
  ...
  GLAD_GL_APPLE_float_pixels =
      glad_gl_has_extension(exts, exts_i, "GL_APPLE_float_pixels");
  GLAD_GL_APPLE_flush_buffer_range =
      glad_gl_has_extension(exts, exts_i, "GL_APPLE_flush_buffer_range");
  GLAD_GL_APPLE_object_purgeable =
      glad_gl_has_extension(exts, exts_i, "GL_APPLE_object_purgeable");
  GLAD_GL_APPLE_rgb_422 =
      glad_gl_has_extension(exts, exts_i, "GL_APPLE_rgb_422");
  GLAD_GL_APPLE_row_bytes =
      glad_gl_has_extension(exts, exts_i, "GL_APPLE_row_bytes");
  GLAD_GL_APPLE_specular_vector =
      glad_gl_has_extension(exts, exts_i, "GL_APPLE_specular_vector");
  GLAD_GL_APPLE_texture_range =
      glad_gl_has_extension(exts, exts_i, "GL_APPLE_texture_range");
  GLAD_GL_APPLE_transform_hint =
      glad_gl_has_extension(exts, exts_i, "GL_APPLE_transform_hint");
  GLAD_GL_APPLE_vertex_array_object =
      glad_gl_has_extension(exts, exts_i, "GL_APPLE_vertex_array_object");
  GLAD_GL_APPLE_vertex_array_range =
      glad_gl_has_extension(exts, exts_i, "GL_APPLE_vertex_array_range");
  GLAD_GL_APPLE_vertex_program_evaluators =
      glad_gl_has_extension(exts, exts_i, "GL_APPLE_vertex_program_evaluators");
  GLAD_GL_APPLE_ycbcr_422 =
      glad_gl_has_extension(exts, exts_i, "GL_APPLE_ycbcr_422");
  GLAD_GL_ARB_ES2_compatibility =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_ES2_compatibility");
  GLAD_GL_ARB_ES3_1_compatibility =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_ES3_1_compatibility");
  GLAD_GL_ARB_ES3_2_compatibility =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_ES3_2_compatibility");
  GLAD_GL_ARB_ES3_compatibility =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_ES3_compatibility");
  GLAD_GL_ARB_arrays_of_arrays =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_arrays_of_arrays");
  GLAD_GL_ARB_base_instance =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_base_instance");
  GLAD_GL_ARB_bindless_texture =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_bindless_texture");
  GLAD_GL_ARB_blend_func_extended =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_blend_func_extended");
  ...
  GLAD_GL_ARB_clear_buffer_object =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_clear_buffer_object");
  ...
  GLAD_GL_ARB_color_buffer_float =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_color_buffer_float");
  GLAD_GL_ARB_compatibility =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_compatibility");
  GLAD_GL_ARB_compressed_texture_pixel_storage = glad_gl_has_extension(
  ...
  GLAD_GL_ARB_compute_variable_group_size =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_compute_variable_group_size");
  GLAD_GL_ARB_conditional_render_inverted =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_conditional_render_inverted");
  GLAD_GL_ARB_conservative_depth =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_conservative_depth");
  ...
  GLAD_GL_ARB_cull_distance =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_cull_distance");
  GLAD_GL_ARB_debug_output =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_debug_output");
  GLAD_GL_ARB_depth_buffer_float =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_depth_buffer_float");
  GLAD_GL_ARB_depth_clamp =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_depth_clamp");
  GLAD_GL_ARB_depth_texture =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_depth_texture");
  ...
  GLAD_GL_ARB_draw_buffers_blend =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_draw_buffers_blend");
  GLAD_GL_ARB_draw_elements_base_vertex =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_draw_elements_base_vertex");
  ...
  GLAD_GL_ARB_enhanced_layouts =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_enhanced_layouts");
  GLAD_GL_ARB_explicit_attrib_location =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_explicit_attrib_location");
  ...
  GLAD_GL_ARB_fragment_coord_conventions =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_fragment_coord_conventions");
  ...
  GLAD_GL_ARB_fragment_program =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_fragment_program");
  GLAD_GL_ARB_fragment_program_shadow =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_fragment_program_shadow");
  GLAD_GL_ARB_fragment_shader =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_fragment_shader");
  GLAD_GL_ARB_fragment_shader_interlock =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_fragment_shader_interlock");
  GLAD_GL_ARB_framebuffer_no_attachments =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_framebuffer_no_attachments");
  GLAD_GL_ARB_framebuffer_object =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_framebuffer_object");
  GLAD_GL_ARB_framebuffer_sRGB =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_framebuffer_sRGB");
  GLAD_GL_ARB_geometry_shader4 =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_geometry_shader4");
  GLAD_GL_ARB_get_program_binary =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_get_program_binary");
  GLAD_GL_ARB_get_texture_sub_image =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_get_texture_sub_image");
  GLAD_GL_ARB_gl_spirv = glad_gl_has_extension(exts, exts_i, "GL_ARB_gl_spirv");
  GLAD_GL_ARB_gpu_shader5 =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_gpu_shader5");
  GLAD_GL_ARB_gpu_shader_fp64 =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_gpu_shader_fp64");
  GLAD_GL_ARB_gpu_shader_int64 =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_gpu_shader_int64");
  GLAD_GL_ARB_half_float_pixel =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_half_float_pixel");
  GLAD_GL_ARB_half_float_vertex =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_half_float_vertex");
  ...
  GLAD_GL_ARB_internalformat_query =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_internalformat_query");
  GLAD_GL_ARB_internalformat_query2 =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_internalformat_query2");
  GLAD_GL_ARB_invalidate_subdata =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_invalidate_subdata");
  ...
  GLAD_GL_ARB_matrix_palette =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_matrix_palette");
  ...
  GLAD_GL_ARB_occlusion_query2 =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_occlusion_query2");
  ...
  GLAD_GL_ARB_pixel_buffer_object =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_pixel_buffer_object");
  GLAD_GL_ARB_point_parameters =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_point_parameters");
  GLAD_GL_ARB_point_sprite =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_point_sprite");
  GLAD_GL_ARB_polygon_offset_clamp =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_polygon_offset_clamp");
  GLAD_GL_ARB_post_depth_coverage =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_post_depth_coverage");
  GLAD_GL_ARB_program_interface_query =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_program_interface_query");
  GLAD_GL_ARB_provoking_vertex =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_provoking_vertex");
  GLAD_GL_ARB_query_buffer_object =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_query_buffer_object");
  GLAD_GL_ARB_robust_buffer_access_behavior = glad_gl_has_extension(
  ...
  GLAD_GL_ARB_robustness_isolation =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_robustness_isolation");
  GLAD_GL_ARB_sample_locations =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_sample_locations");
  ...
  GLAD_GL_ARB_seamless_cube_map =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_seamless_cube_map");
  ...
  GLAD_GL_ARB_shader_atomic_counter_ops =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_shader_atomic_counter_ops");
  GLAD_GL_ARB_shader_atomic_counters =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_shader_atomic_counters");
  GLAD_GL_ARB_shader_ballot =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_shader_ballot");
  GLAD_GL_ARB_shader_bit_encoding =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_shader_bit_encoding");
  GLAD_GL_ARB_shader_clock =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_shader_clock");
  GLAD_GL_ARB_shader_draw_parameters =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_shader_draw_parameters");
  GLAD_GL_ARB_shader_group_vote =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_shader_group_vote");
  GLAD_GL_ARB_shader_image_load_store =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_shader_image_load_store");
  GLAD_GL_ARB_shader_image_size =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_shader_image_size");
  GLAD_GL_ARB_shader_objects =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_shader_objects");
  GLAD_GL_ARB_shader_precision =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_shader_precision");
  GLAD_GL_ARB_shader_stencil_export =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_shader_stencil_export");
  ...
  GLAD_GL_ARB_shader_subroutine =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_shader_subroutine");
  GLAD_GL_ARB_shader_texture_image_samples = glad_gl_has_extension(
      exts, exts_i, "GL_ARB_shader_texture_image_samples");
  GLAD_GL_ARB_shader_texture_lod =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_shader_texture_lod");
  GLAD_GL_ARB_shader_viewport_layer_array =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_shader_viewport_layer_array");
  GLAD_GL_ARB_shading_language_100 =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_shading_language_100");
  ...
  GLAD_GL_ARB_shading_language_packing =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_shading_language_packing");
  GLAD_GL_ARB_shadow = glad_gl_has_extension(exts, exts_i, "GL_ARB_shadow");
  GLAD_GL_ARB_shadow_ambient =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_shadow_ambient");
  GLAD_GL_ARB_sparse_buffer =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_sparse_buffer");
  GLAD_GL_ARB_sparse_texture =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_sparse_texture");
  GLAD_GL_ARB_sparse_texture2 =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_sparse_texture2");
  GLAD_GL_ARB_sparse_texture_clamp =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_sparse_texture_clamp");
  GLAD_GL_ARB_spirv_extensions =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_spirv_extensions");
  GLAD_GL_ARB_stencil_texturing =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_stencil_texturing");
  GLAD_GL_ARB_sync = glad_gl_has_extension(exts, exts_i, "GL_ARB_sync");
  GLAD_GL_ARB_tessellation_shader =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_tessellation_shader");
  GLAD_GL_ARB_texture_barrier =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_barrier");
  GLAD_GL_ARB_texture_border_clamp =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_border_clamp");
  GLAD_GL_ARB_texture_buffer_object =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_buffer_object");
  GLAD_GL_ARB_texture_buffer_object_rgb32 =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_buffer_object_rgb32");
  ...
  GLAD_GL_ARB_texture_compression =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_compression");
  GLAD_GL_ARB_texture_compression_bptc =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_compression_bptc");
  GLAD_GL_ARB_texture_compression_rgtc =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_compression_rgtc");
  GLAD_GL_ARB_texture_cube_map =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_cube_map");
  GLAD_GL_ARB_texture_cube_map_array =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_cube_map_array");
  GLAD_GL_ARB_texture_env_add =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_env_add");
  GLAD_GL_ARB_texture_env_combine =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_env_combine");
  GLAD_GL_ARB_texture_env_crossbar =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_env_crossbar");
  GLAD_GL_ARB_texture_env_dot3 =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_env_dot3");
  GLAD_GL_ARB_texture_filter_anisotropic =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_filter_anisotropic");
  GLAD_GL_ARB_texture_filter_minmax =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_filter_minmax");
  GLAD_GL_ARB_texture_float =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_float");
  GLAD_GL_ARB_texture_gather =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_gather");
  ...
  GLAD_GL_ARB_texture_mirrored_repeat =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_mirrored_repeat");
  ...
  GLAD_GL_ARB_texture_non_power_of_two =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_non_power_of_two");
  GLAD_GL_ARB_texture_query_levels =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_query_levels");
  GLAD_GL_ARB_texture_query_lod =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_query_lod");
  GLAD_GL_ARB_texture_rectangle =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_rectangle");
  GLAD_GL_ARB_texture_rg =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_rg");
  GLAD_GL_ARB_texture_rgb10_a2ui =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_rgb10_a2ui");
  GLAD_GL_ARB_texture_stencil8 =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_stencil8");
  ...
  GLAD_GL_ARB_texture_storage_multisample =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_storage_multisample");
  GLAD_GL_ARB_texture_swizzle =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_texture_swizzle");
  ...
  GLAD_GL_ARB_transform_feedback2 =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_transform_feedback2");
  GLAD_GL_ARB_transform_feedback3 =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_transform_feedback3");
  GLAD_GL_ARB_transform_feedback_instanced = glad_gl_has_extension(
      exts, exts_i, "GL_ARB_transform_feedback_instanced");
  GLAD_GL_ARB_transform_feedback_overflow_query = glad_gl_has_extension(
      exts, exts_i, "GL_ARB_transform_feedback_overflow_query");
  GLAD_GL_ARB_transpose_matrix =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_transpose_matrix");
  GLAD_GL_ARB_uniform_buffer_object =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_uniform_buffer_object");
  GLAD_GL_ARB_vertex_array_bgra =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_vertex_array_bgra");
  GLAD_GL_ARB_vertex_array_object =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_vertex_array_object");
  GLAD_GL_ARB_vertex_attrib_64bit =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_vertex_attrib_64bit");
  GLAD_GL_ARB_vertex_attrib_binding =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_vertex_attrib_binding");
  GLAD_GL_ARB_vertex_blend =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_vertex_blend");
  GLAD_GL_ARB_vertex_buffer_object =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_vertex_buffer_object");
  ...
  GLAD_GL_ARB_vertex_type_10f_11f_11f_rev =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_vertex_type_10f_11f_11f_rev");
  GLAD_GL_ARB_vertex_type_2_10_10_10_rev =
      glad_gl_has_extension(exts, exts_i, "GL_ARB_vertex_type_2_10_10_10_rev");
  ...
  GLAD_GL_ATI_element_array =
      glad_gl_has_extension(exts, exts_i, "GL_ATI_element_array");
  GLAD_GL_ATI_envmap_bumpmap =
      glad_gl_has_extension(exts, exts_i, "GL_ATI_envmap_bumpmap");
  GLAD_GL_ATI_fragment_shader =
      glad_gl_has_extension(exts, exts_i, "GL_ATI_fragment_shader");
  GLAD_GL_ATI_map_object_buffer =
      glad_gl_has_extension(exts, exts_i, "GL_ATI_map_object_buffer");
  ...
  GLAD_GL_ATI_pn_triangles =
      glad_gl_has_extension(exts, exts_i, "GL_ATI_pn_triangles");
  GLAD_GL_ATI_separate_stencil =
      glad_gl_has_extension(exts, exts_i, "GL_ATI_separate_stencil");
  GLAD_GL_ATI_text_fragment_shader =
      glad_gl_has_extension(exts, exts_i, "GL_ATI_text_fragment_shader");
  GLAD_GL_ATI_texture_env_combine3 =
      glad_gl_has_extension(exts, exts_i, "GL_ATI_texture_env_combine3");
  GLAD_GL_ATI_texture_float =
      glad_gl_has_extension(exts, exts_i, "GL_ATI_texture_float");
  GLAD_GL_ATI_texture_mirror_once =
      glad_gl_has_extension(exts, exts_i, "GL_ATI_texture_mirror_once");
  GLAD_GL_ATI_vertex_array_object =
      glad_gl_has_extension(exts, exts_i, "GL_ATI_vertex_array_object");
  GLAD_GL_ATI_vertex_attrib_array_object =
      glad_gl_has_extension(exts, exts_i, "GL_ATI_vertex_attrib_array_object");
  GLAD_GL_ATI_vertex_streams =
      glad_gl_has_extension(exts, exts_i, "GL_ATI_vertex_streams");
  GLAD_GL_EXT_422_pixels =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_422_pixels");
  ...
  GLAD_GL_EXT_bindable_uniform =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_bindable_uniform");
  GLAD_GL_EXT_blend_color =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_blend_color");
  GLAD_GL_EXT_blend_equation_separate =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_blend_equation_separate");
  GLAD_GL_EXT_blend_func_separate =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_blend_func_separate");
  GLAD_GL_EXT_blend_logic_op =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_blend_logic_op");
  GLAD_GL_EXT_blend_minmax =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_blend_minmax");
  GLAD_GL_EXT_blend_subtract =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_blend_subtract");
  ...
  GLAD_GL_EXT_color_subtable =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_color_subtable");
  GLAD_GL_EXT_compiled_vertex_array =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_compiled_vertex_array");
  GLAD_GL_EXT_convolution =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_convolution");
  GLAD_GL_EXT_coordinate_frame =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_coordinate_frame");
  GLAD_GL_EXT_copy_texture =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_copy_texture");
  GLAD_GL_EXT_cull_vertex =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_cull_vertex");
  GLAD_GL_EXT_debug_label =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_debug_label");
  GLAD_GL_EXT_debug_marker =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_debug_marker");
  ...
  GLAD_GL_EXT_external_buffer =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_external_buffer");
  GLAD_GL_EXT_fog_coord =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_fog_coord");
  GLAD_GL_EXT_fragment_shading_rate =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_fragment_shading_rate");
  GLAD_GL_EXT_framebuffer_blit =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_framebuffer_blit");
  GLAD_GL_EXT_framebuffer_blit_layers =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_framebuffer_blit_layers");
  GLAD_GL_EXT_framebuffer_multisample =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_framebuffer_multisample");
  GLAD_GL_EXT_framebuffer_multisample_blit_scaled = glad_gl_has_extension(
      exts, exts_i, "GL_EXT_framebuffer_multisample_blit_scaled");
  GLAD_GL_EXT_framebuffer_object =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_framebuffer_object");
  GLAD_GL_EXT_framebuffer_sRGB =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_framebuffer_sRGB");
  GLAD_GL_EXT_geometry_shader4 =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_geometry_shader4");
  GLAD_GL_EXT_gpu_program_parameters =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_gpu_program_parameters");
  GLAD_GL_EXT_gpu_shader4 =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_gpu_shader4");
  GLAD_GL_EXT_histogram =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_histogram");
  GLAD_GL_EXT_index_array_formats =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_index_array_formats");
  GLAD_GL_EXT_index_func =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_index_func");
  GLAD_GL_EXT_index_material =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_index_material");
  ...
  GLAD_GL_EXT_memory_object =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_memory_object");
  GLAD_GL_EXT_memory_object_fd =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_memory_object_fd");
  GLAD_GL_EXT_memory_object_win32 =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_memory_object_win32");
  GLAD_GL_EXT_mesh_shader =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_mesh_shader");
  GLAD_GL_EXT_misc_attribute =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_misc_attribute");
  GLAD_GL_EXT_multi_draw_arrays =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_multi_draw_arrays");
  GLAD_GL_EXT_multisample =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_multisample");
  GLAD_GL_EXT_multiview_tessellation_geometry_shader = glad_gl_has_extension(
      exts, exts_i, "GL_EXT_multiview_tessellation_geometry_shader");
  GLAD_GL_EXT_multiview_texture_multisample = glad_gl_has_extension(
      exts, exts_i, "GL_EXT_multiview_texture_multisample");
  GLAD_GL_EXT_multiview_timer_query =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_multiview_timer_query");
  GLAD_GL_EXT_packed_depth_stencil =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_packed_depth_stencil");
  GLAD_GL_EXT_packed_float =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_packed_float");
  GLAD_GL_EXT_packed_pixels =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_packed_pixels");
  GLAD_GL_EXT_paletted_texture =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_paletted_texture");
  GLAD_GL_EXT_pixel_buffer_object =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_pixel_buffer_object");
  GLAD_GL_EXT_pixel_transform =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_pixel_transform");
  GLAD_GL_EXT_pixel_transform_color_table =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_pixel_transform_color_table");
  GLAD_GL_EXT_point_parameters =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_point_parameters");
  GLAD_GL_EXT_polygon_offset =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_polygon_offset");
  GLAD_GL_EXT_polygon_offset_clamp =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_polygon_offset_clamp");
  ...
  GLAD_GL_EXT_raster_multisample =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_raster_multisample");
  GLAD_GL_EXT_rescale_normal =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_rescale_normal");
  GLAD_GL_EXT_secondary_color =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_secondary_color");
  GLAD_GL_EXT_semaphore =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_semaphore");
  GLAD_GL_EXT_semaphore_fd =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_semaphore_fd");
  GLAD_GL_EXT_semaphore_win32 =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_semaphore_win32");
  GLAD_GL_EXT_separate_shader_objects =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_separate_shader_objects");
  GLAD_GL_EXT_separate_specular_color =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_separate_specular_color");
  GLAD_GL_EXT_shader_framebuffer_fetch =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_shader_framebuffer_fetch");
  GLAD_GL_EXT_shader_framebuffer_fetch_non_coherent = glad_gl_has_extension(
      exts, exts_i, "GL_EXT_shader_framebuffer_fetch_non_coherent");
  GLAD_GL_EXT_shader_image_load_formatted =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_shader_image_load_formatted");
  GLAD_GL_EXT_shader_image_load_store =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_shader_image_load_store");
  GLAD_GL_EXT_shader_integer_mix =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_shader_integer_mix");
  GLAD_GL_EXT_shader_samples_identical =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_shader_samples_identical");
  GLAD_GL_EXT_shadow_funcs =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_shadow_funcs");
  GLAD_GL_EXT_shared_texture_palette =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_shared_texture_palette");
  GLAD_GL_EXT_sparse_texture2 =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_sparse_texture2");
  GLAD_GL_EXT_stencil_clear_tag =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_stencil_clear_tag");
  GLAD_GL_EXT_stencil_two_side =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_stencil_two_side");
  GLAD_GL_EXT_stencil_wrap =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_stencil_wrap");
  ...
  GLAD_GL_EXT_texture_buffer_object =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_texture_buffer_object");
  GLAD_GL_EXT_texture_compression_latc =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_texture_compression_latc");
  GLAD_GL_EXT_texture_compression_rgtc =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_texture_compression_rgtc");
  GLAD_GL_EXT_texture_compression_s3tc =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_texture_compression_s3tc");
  GLAD_GL_EXT_texture_cube_map =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_texture_cube_map");
  GLAD_GL_EXT_texture_env_add =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_texture_env_add");
  GLAD_GL_EXT_texture_env_combine =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_texture_env_combine");
  GLAD_GL_EXT_texture_env_dot3 =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_texture_env_dot3");
  ...
  GLAD_GL_EXT_texture_filter_minmax =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_texture_filter_minmax");
  GLAD_GL_EXT_texture_integer =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_texture_integer");
  GLAD_GL_EXT_texture_lod_bias =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_texture_lod_bias");
  GLAD_GL_EXT_texture_mirror_clamp =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_texture_mirror_clamp");
  GLAD_GL_EXT_texture_object =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_texture_object");
  GLAD_GL_EXT_texture_perturb_normal =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_texture_perturb_normal");
  GLAD_GL_EXT_texture_sRGB =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_texture_sRGB");
  GLAD_GL_EXT_texture_sRGB_R8 =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_texture_sRGB_R8");
  GLAD_GL_EXT_texture_sRGB_RG8 =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_texture_sRGB_RG8");
  GLAD_GL_EXT_texture_sRGB_decode =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_texture_sRGB_decode");
  GLAD_GL_EXT_texture_shadow_lod =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_texture_shadow_lod");
  GLAD_GL_EXT_texture_shared_exponent =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_texture_shared_exponent");
  GLAD_GL_EXT_texture_snorm =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_texture_snorm");
  ...
  GLAD_GL_EXT_transform_feedback =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_transform_feedback");
  GLAD_GL_EXT_vertex_array =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_vertex_array");
  GLAD_GL_EXT_vertex_array_bgra =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_vertex_array_bgra");
  GLAD_GL_EXT_vertex_attrib_64bit =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_vertex_attrib_64bit");
  GLAD_GL_EXT_vertex_shader =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_vertex_shader");
  GLAD_GL_EXT_vertex_weighting =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_vertex_weighting");
  GLAD_GL_EXT_win32_keyed_mutex =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_win32_keyed_mutex");
  GLAD_GL_EXT_window_rectangles =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_window_rectangles");
  GLAD_GL_EXT_x11_sync_object =
      glad_gl_has_extension(exts, exts_i, "GL_EXT_x11_sync_object");
  GLAD_GL_GREMEDY_frame_terminator =
      glad_gl_has_extension(exts, exts_i, "GL_GREMEDY_frame_terminator");
  GLAD_GL_GREMEDY_string_marker =
      glad_gl_has_extension(exts, exts_i, "GL_GREMEDY_string_marker");
  GLAD_GL_HP_convolution_border_modes =
      glad_gl_has_extension(exts, exts_i, "GL_HP_convolution_border_modes");
  GLAD_GL_HP_image_transform =
      glad_gl_has_extension(exts, exts_i, "GL_HP_image_transform");
  GLAD_GL_HP_occlusion_test =
      glad_gl_has_extension(exts, exts_i, "GL_HP_occlusion_test");
  GLAD_GL_HP_texture_lighting =
      glad_gl_has_extension(exts, exts_i, "GL_HP_texture_lighting");
  GLAD_GL_IBM_cull_vertex =
      glad_gl_has_extension(exts, exts_i, "GL_IBM_cull_vertex");
  GLAD_GL_IBM_multimode_draw_arrays =
      glad_gl_has_extension(exts, exts_i, "GL_IBM_multimode_draw_arrays");
  GLAD_GL_IBM_rasterpos_clip =
      glad_gl_has_extension(exts, exts_i, "GL_IBM_rasterpos_clip");
  GLAD_GL_IBM_static_data =
      glad_gl_has_extension(exts, exts_i, "GL_IBM_static_data");
  GLAD_GL_IBM_texture_mirrored_repeat =
      glad_gl_has_extension(exts, exts_i, "GL_IBM_texture_mirrored_repeat");
  GLAD_GL_IBM_vertex_array_lists =
      glad_gl_has_extension(exts, exts_i, "GL_IBM_vertex_array_lists");
  GLAD_GL_INGR_blend_func_separate =
      glad_gl_has_extension(exts, exts_i, "GL_INGR_blend_func_separate");
  GLAD_GL_INGR_color_clamp =
      glad_gl_has_extension(exts, exts_i, "GL_INGR_color_clamp");
  GLAD_GL_INGR_interlace_read =
      glad_gl_has_extension(exts, exts_i, "GL_INGR_interlace_read");
  GLAD_GL_INTEL_blackhole_render =
      glad_gl_has_extension(exts, exts_i, "GL_INTEL_blackhole_render");
  GLAD_GL_INTEL_conservative_rasterization = glad_gl_has_extension(
      exts, exts_i, "GL_INTEL_conservative_rasterization");
  GLAD_GL_INTEL_fragment_shader_ordering =
      glad_gl_has_extension(exts, exts_i, "GL_INTEL_fragment_shader_ordering");
  GLAD_GL_INTEL_framebuffer_CMAA =
      glad_gl_has_extension(exts, exts_i, "GL_INTEL_framebuffer_CMAA");
  GLAD_GL_INTEL_map_texture =
      glad_gl_has_extension(exts, exts_i, "GL_INTEL_map_texture");
  GLAD_GL_INTEL_parallel_arrays =
      glad_gl_has_extension(exts, exts_i, "GL_INTEL_parallel_arrays");
  GLAD_GL_INTEL_performance_query =
      glad_gl_has_extension(exts, exts_i, "GL_INTEL_performance_query");
  GLAD_GL_KHR_blend_equation_advanced =
      glad_gl_has_extension(exts, exts_i, "GL_KHR_blend_equation_advanced");
  GLAD_GL_KHR_blend_equation_advanced_coherent = glad_gl_has_extension(
      exts, exts_i, "GL_KHR_blend_equation_advanced_coherent");
  GLAD_GL_KHR_context_flush_control =
      glad_gl_has_extension(exts, exts_i, "GL_KHR_context_flush_control");
  ...
  GLAD_GL_KHR_parallel_shader_compile =
      glad_gl_has_extension(exts, exts_i, "GL_KHR_parallel_shader_compile");
  GLAD_GL_KHR_robust_buffer_access_behavior = glad_gl_has_extension(
  ...
  GLAD_GL_KHR_shader_subgroup =
      glad_gl_has_extension(exts, exts_i, "GL_KHR_shader_subgroup");
  ...
  GLAD_GL_KHR_texture_compression_astc_sliced_3d = glad_gl_has_extension(
      exts, exts_i, "GL_KHR_texture_compression_astc_sliced_3d");
  GLAD_GL_MESAX_texture_stack =
      glad_gl_has_extension(exts, exts_i, "GL_MESAX_texture_stack");
  GLAD_GL_MESA_framebuffer_flip_x =
      glad_gl_has_extension(exts, exts_i, "GL_MESA_framebuffer_flip_x");
  GLAD_GL_MESA_framebuffer_flip_y =
      glad_gl_has_extension(exts, exts_i, "GL_MESA_framebuffer_flip_y");
  GLAD_GL_MESA_framebuffer_swap_xy =
      glad_gl_has_extension(exts, exts_i, "GL_MESA_framebuffer_swap_xy");
  GLAD_GL_MESA_pack_invert =
      glad_gl_has_extension(exts, exts_i, "GL_MESA_pack_invert");
  GLAD_GL_MESA_program_binary_formats =
      glad_gl_has_extension(exts, exts_i, "GL_MESA_program_binary_formats");
  GLAD_GL_MESA_resize_buffers =
      glad_gl_has_extension(exts, exts_i, "GL_MESA_resize_buffers");
  GLAD_GL_MESA_shader_integer_functions =
      glad_gl_has_extension(exts, exts_i, "GL_MESA_shader_integer_functions");
  GLAD_GL_MESA_texture_const_bandwidth =
      glad_gl_has_extension(exts, exts_i, "GL_MESA_texture_const_bandwidth");
  GLAD_GL_MESA_tile_raster_order =
      glad_gl_has_extension(exts, exts_i, "GL_MESA_tile_raster_order");
  GLAD_GL_MESA_window_pos =
      glad_gl_has_extension(exts, exts_i, "GL_MESA_window_pos");
  GLAD_GL_MESA_ycbcr_texture =
      glad_gl_has_extension(exts, exts_i, "GL_MESA_ycbcr_texture");
  ...
  GLAD_GL_NVX_conditional_render =
      glad_gl_has_extension(exts, exts_i, "GL_NVX_conditional_render");
  GLAD_GL_NVX_gpu_memory_info =
      glad_gl_has_extension(exts, exts_i, "GL_NVX_gpu_memory_info");
  GLAD_GL_NVX_gpu_multicast2 =
      glad_gl_has_extension(exts, exts_i, "GL_NVX_gpu_multicast2");
  GLAD_GL_NVX_linked_gpu_multicast =
      glad_gl_has_extension(exts, exts_i, "GL_NVX_linked_gpu_multicast");
  GLAD_GL_NVX_progress_fence =
      glad_gl_has_extension(exts, exts_i, "GL_NVX_progress_fence");
  GLAD_GL_NV_alpha_to_coverage_dither_control = glad_gl_has_extension(
      exts, exts_i, "GL_NV_alpha_to_coverage_dither_control");
  GLAD_GL_NV_bindless_multi_draw_indirect =
      glad_gl_has_extension(exts, exts_i, "GL_NV_bindless_multi_draw_indirect");
  GLAD_GL_NV_bindless_multi_draw_indirect_count = glad_gl_has_extension(
  ...
  GLAD_GL_NV_blend_equation_advanced =
      glad_gl_has_extension(exts, exts_i, "GL_NV_blend_equation_advanced");
  GLAD_GL_NV_blend_equation_advanced_coherent = glad_gl_has_extension(
      exts, exts_i, "GL_NV_blend_equation_advanced_coherent");
  GLAD_GL_NV_blend_minmax_factor =
      glad_gl_has_extension(exts, exts_i, "GL_NV_blend_minmax_factor");
  GLAD_GL_NV_blend_square =
      glad_gl_has_extension(exts, exts_i, "GL_NV_blend_square");
  GLAD_GL_NV_clip_space_w_scaling =
      glad_gl_has_extension(exts, exts_i, "GL_NV_clip_space_w_scaling");
  GLAD_GL_NV_command_list =
      glad_gl_has_extension(exts, exts_i, "GL_NV_command_list");
  GLAD_GL_NV_compute_program5 =
      glad_gl_has_extension(exts, exts_i, "GL_NV_compute_program5");
  GLAD_GL_NV_compute_shader_derivatives =
      glad_gl_has_extension(exts, exts_i, "GL_NV_compute_shader_derivatives");
  GLAD_GL_NV_conditional_render =
      glad_gl_has_extension(exts, exts_i, "GL_NV_conditional_render");
  GLAD_GL_NV_conservative_raster =
      glad_gl_has_extension(exts, exts_i, "GL_NV_conservative_raster");
  GLAD_GL_NV_conservative_raster_dilate =
      glad_gl_has_extension(exts, exts_i, "GL_NV_conservative_raster_dilate");
  GLAD_GL_NV_conservative_raster_pre_snap =
      glad_gl_has_extension(exts, exts_i, "GL_NV_conservative_raster_pre_snap");
  GLAD_GL_NV_conservative_raster_pre_snap_triangles = glad_gl_has_extension(
      exts, exts_i, "GL_NV_conservative_raster_pre_snap_triangles");
  GLAD_GL_NV_conservative_raster_underestimation = glad_gl_has_extension(
      exts, exts_i, "GL_NV_conservative_raster_underestimation");
  GLAD_GL_NV_copy_depth_to_color =
      glad_gl_has_extension(exts, exts_i, "GL_NV_copy_depth_to_color");
  GLAD_GL_NV_copy_image =
      glad_gl_has_extension(exts, exts_i, "GL_NV_copy_image");
  GLAD_GL_NV_deep_texture3D =
      glad_gl_has_extension(exts, exts_i, "GL_NV_deep_texture3D");
  GLAD_GL_NV_depth_buffer_float =
      glad_gl_has_extension(exts, exts_i, "GL_NV_depth_buffer_float");
  GLAD_GL_NV_depth_clamp =
      glad_gl_has_extension(exts, exts_i, "GL_NV_depth_clamp");
  GLAD_GL_NV_draw_texture =
      glad_gl_has_extension(exts, exts_i, "GL_NV_draw_texture");
  GLAD_GL_NV_draw_vulkan_image =
      glad_gl_has_extension(exts, exts_i, "GL_NV_draw_vulkan_image");
  GLAD_GL_NV_evaluators =
      glad_gl_has_extension(exts, exts_i, "GL_NV_evaluators");
  GLAD_GL_NV_explicit_multisample =
      glad_gl_has_extension(exts, exts_i, "GL_NV_explicit_multisample");
  GLAD_GL_NV_fence = glad_gl_has_extension(exts, exts_i, "GL_NV_fence");
  GLAD_GL_NV_fill_rectangle =
      glad_gl_has_extension(exts, exts_i, "GL_NV_fill_rectangle");
  GLAD_GL_NV_float_buffer =
      glad_gl_has_extension(exts, exts_i, "GL_NV_float_buffer");
  GLAD_GL_NV_fog_distance =
      glad_gl_has_extension(exts, exts_i, "GL_NV_fog_distance");
  GLAD_GL_NV_fragment_coverage_to_color =
      glad_gl_has_extension(exts, exts_i, "GL_NV_fragment_coverage_to_color");
  GLAD_GL_NV_fragment_program =
      glad_gl_has_extension(exts, exts_i, "GL_NV_fragment_program");
  GLAD_GL_NV_fragment_program2 =
      glad_gl_has_extension(exts, exts_i, "GL_NV_fragment_program2");
  GLAD_GL_NV_fragment_program4 =
      glad_gl_has_extension(exts, exts_i, "GL_NV_fragment_program4");
  GLAD_GL_NV_fragment_program_option =
      glad_gl_has_extension(exts, exts_i, "GL_NV_fragment_program_option");
  ...
  GLAD_GL_NV_fragment_shader_interlock =
      glad_gl_has_extension(exts, exts_i, "GL_NV_fragment_shader_interlock");
  GLAD_GL_NV_framebuffer_mixed_samples =
      glad_gl_has_extension(exts, exts_i, "GL_NV_framebuffer_mixed_samples");
  GLAD_GL_NV_framebuffer_multisample_coverage = glad_gl_has_extension(
  ...
  GLAD_GL_NV_geometry_shader4 =
      glad_gl_has_extension(exts, exts_i, "GL_NV_geometry_shader4");
  ...
  GLAD_GL_NV_gpu_multicast =
      glad_gl_has_extension(exts, exts_i, "GL_NV_gpu_multicast");
  GLAD_GL_NV_gpu_program4 =
      glad_gl_has_extension(exts, exts_i, "GL_NV_gpu_program4");
  GLAD_GL_NV_gpu_program5 =
      glad_gl_has_extension(exts, exts_i, "GL_NV_gpu_program5");
  GLAD_GL_NV_gpu_program5_mem_extended =
      glad_gl_has_extension(exts, exts_i, "GL_NV_gpu_program5_mem_extended");
  GLAD_GL_NV_gpu_shader5 =
      glad_gl_has_extension(exts, exts_i, "GL_NV_gpu_shader5");
  GLAD_GL_NV_half_float =
      glad_gl_has_extension(exts, exts_i, "GL_NV_half_float");
  GLAD_GL_NV_internalformat_sample_query =
      glad_gl_has_extension(exts, exts_i, "GL_NV_internalformat_sample_query");
  GLAD_GL_NV_light_max_exponent =
      glad_gl_has_extension(exts, exts_i, "GL_NV_light_max_exponent");
  GLAD_GL_NV_memory_attachment =
      glad_gl_has_extension(exts, exts_i, "GL_NV_memory_attachment");
  GLAD_GL_NV_memory_object_sparse =
      glad_gl_has_extension(exts, exts_i, "GL_NV_memory_object_sparse");
  GLAD_GL_NV_mesh_shader =
      glad_gl_has_extension(exts, exts_i, "GL_NV_mesh_shader");
  GLAD_GL_NV_multisample_coverage =
      glad_gl_has_extension(exts, exts_i, "GL_NV_multisample_coverage");
  GLAD_GL_NV_multisample_filter_hint =
      glad_gl_has_extension(exts, exts_i, "GL_NV_multisample_filter_hint");
  GLAD_GL_NV_occlusion_query =
      glad_gl_has_extension(exts, exts_i, "GL_NV_occlusion_query");
  GLAD_GL_NV_packed_depth_stencil =
      glad_gl_has_extension(exts, exts_i, "GL_NV_packed_depth_stencil");
  GLAD_GL_NV_parameter_buffer_object =
      glad_gl_has_extension(exts, exts_i, "GL_NV_parameter_buffer_object");
  GLAD_GL_NV_parameter_buffer_object2 =
      glad_gl_has_extension(exts, exts_i, "GL_NV_parameter_buffer_object2");
  GLAD_GL_NV_path_rendering =
      glad_gl_has_extension(exts, exts_i, "GL_NV_path_rendering");
  GLAD_GL_NV_path_rendering_shared_edge =
      glad_gl_has_extension(exts, exts_i, "GL_NV_path_rendering_shared_edge");
  GLAD_GL_NV_pixel_data_range =
      glad_gl_has_extension(exts, exts_i, "GL_NV_pixel_data_range");
  GLAD_GL_NV_point_sprite =
      glad_gl_has_extension(exts, exts_i, "GL_NV_point_sprite");
  GLAD_GL_NV_present_video =
      glad_gl_has_extension(exts, exts_i, "GL_NV_present_video");
  GLAD_GL_NV_primitive_restart =
      glad_gl_has_extension(exts, exts_i, "GL_NV_primitive_restart");
  GLAD_GL_NV_primitive_shading_rate =
      glad_gl_has_extension(exts, exts_i, "GL_NV_primitive_shading_rate");
  GLAD_GL_NV_query_resource =
      glad_gl_has_extension(exts, exts_i, "GL_NV_query_resource");
  GLAD_GL_NV_query_resource_tag =
      glad_gl_has_extension(exts, exts_i, "GL_NV_query_resource_tag");
  GLAD_GL_NV_register_combiners =
      glad_gl_has_extension(exts, exts_i, "GL_NV_register_combiners");
  GLAD_GL_NV_register_combiners2 =
      glad_gl_has_extension(exts, exts_i, "GL_NV_register_combiners2");
  GLAD_GL_NV_representative_fragment_test =
      glad_gl_has_extension(exts, exts_i, "GL_NV_representative_fragment_test");
  GLAD_GL_NV_robustness_video_memory_purge = glad_gl_has_extension(
      exts, exts_i, "GL_NV_robustness_video_memory_purge");
  GLAD_GL_NV_sample_locations =
      glad_gl_has_extension(exts, exts_i, "GL_NV_sample_locations");
  GLAD_GL_NV_sample_mask_override_coverage = glad_gl_has_extension(
      exts, exts_i, "GL_NV_sample_mask_override_coverage");
  GLAD_GL_NV_scissor_exclusive =
      glad_gl_has_extension(exts, exts_i, "GL_NV_scissor_exclusive");
  ...
  GLAD_GL_NV_shader_atomic_float =
      glad_gl_has_extension(exts, exts_i, "GL_NV_shader_atomic_float");
  GLAD_GL_NV_shader_atomic_float64 =
      glad_gl_has_extension(exts, exts_i, "GL_NV_shader_atomic_float64");
  GLAD_GL_NV_shader_atomic_fp16_vector =
      glad_gl_has_extension(exts, exts_i, "GL_NV_shader_atomic_fp16_vector");
  GLAD_GL_NV_shader_atomic_int64 =
      glad_gl_has_extension(exts, exts_i, "GL_NV_shader_atomic_int64");
  GLAD_GL_NV_shader_buffer_load =
      glad_gl_has_extension(exts, exts_i, "GL_NV_shader_buffer_load");
  GLAD_GL_NV_shader_buffer_store =
      glad_gl_has_extension(exts, exts_i, "GL_NV_shader_buffer_store");
  GLAD_GL_NV_shader_storage_buffer_object =
      glad_gl_has_extension(exts, exts_i, "GL_NV_shader_storage_buffer_object");
  GLAD_GL_NV_shader_subgroup_partitioned =
      glad_gl_has_extension(exts, exts_i, "GL_NV_shader_subgroup_partitioned");
  GLAD_GL_NV_shader_texture_footprint =
      glad_gl_has_extension(exts, exts_i, "GL_NV_shader_texture_footprint");
  GLAD_GL_NV_shader_thread_group =
      glad_gl_has_extension(exts, exts_i, "GL_NV_shader_thread_group");
  GLAD_GL_NV_shader_thread_shuffle =
      glad_gl_has_extension(exts, exts_i, "GL_NV_shader_thread_shuffle");
  GLAD_GL_NV_shading_rate_image =
      glad_gl_has_extension(exts, exts_i, "GL_NV_shading_rate_image");
  GLAD_GL_NV_stereo_view_rendering =
      glad_gl_has_extension(exts, exts_i, "GL_NV_stereo_view_rendering");
  GLAD_GL_NV_tessellation_program5 =
      glad_gl_has_extension(exts, exts_i, "GL_NV_tessellation_program5");
  GLAD_GL_NV_texgen_emboss =
      glad_gl_has_extension(exts, exts_i, "GL_NV_texgen_emboss");
  GLAD_GL_NV_texgen_reflection =
      glad_gl_has_extension(exts, exts_i, "GL_NV_texgen_reflection");
  GLAD_GL_NV_texture_barrier =
      glad_gl_has_extension(exts, exts_i, "GL_NV_texture_barrier");
  GLAD_GL_NV_texture_compression_vtc =
      glad_gl_has_extension(exts, exts_i, "GL_NV_texture_compression_vtc");
  GLAD_GL_NV_texture_env_combine4 =
      glad_gl_has_extension(exts, exts_i, "GL_NV_texture_env_combine4");
  GLAD_GL_NV_texture_expand_normal =
      glad_gl_has_extension(exts, exts_i, "GL_NV_texture_expand_normal");
  GLAD_GL_NV_texture_multisample =
      glad_gl_has_extension(exts, exts_i, "GL_NV_texture_multisample");
  ...
  GLAD_GL_NV_texture_rectangle_compressed =
      glad_gl_has_extension(exts, exts_i, "GL_NV_texture_rectangle_compressed");
  GLAD_GL_NV_texture_shader =
      glad_gl_has_extension(exts, exts_i, "GL_NV_texture_shader");
  GLAD_GL_NV_texture_shader2 =
      glad_gl_has_extension(exts, exts_i, "GL_NV_texture_shader2");
  GLAD_GL_NV_texture_shader3 =
      glad_gl_has_extension(exts, exts_i, "GL_NV_texture_shader3");
  GLAD_GL_NV_timeline_semaphore =
      glad_gl_has_extension(exts, exts_i, "GL_NV_timeline_semaphore");
  GLAD_GL_NV_transform_feedback =
      glad_gl_has_extension(exts, exts_i, "GL_NV_transform_feedback");
  GLAD_GL_NV_transform_feedback2 =
      glad_gl_has_extension(exts, exts_i, "GL_NV_transform_feedback2");
  GLAD_GL_NV_uniform_buffer_std430_layout =
      glad_gl_has_extension(exts, exts_i, "GL_NV_uniform_buffer_std430_layout");
  GLAD_GL_NV_uniform_buffer_unified_memory = glad_gl_has_extension(
      exts, exts_i, "GL_NV_uniform_buffer_unified_memory");
  GLAD_GL_NV_vdpau_interop =
      glad_gl_has_extension(exts, exts_i, "GL_NV_vdpau_interop");
  GLAD_GL_NV_vdpau_interop2 =
      glad_gl_has_extension(exts, exts_i, "GL_NV_vdpau_interop2");
  GLAD_GL_NV_vertex_array_range =
      glad_gl_has_extension(exts, exts_i, "GL_NV_vertex_array_range");
  GLAD_GL_NV_vertex_array_range2 =
      glad_gl_has_extension(exts, exts_i, "GL_NV_vertex_array_range2");
  GLAD_GL_NV_vertex_attrib_integer_64bit =
      glad_gl_has_extension(exts, exts_i, "GL_NV_vertex_attrib_integer_64bit");
  GLAD_GL_NV_vertex_buffer_unified_memory =
      glad_gl_has_extension(exts, exts_i, "GL_NV_vertex_buffer_unified_memory");
  GLAD_GL_NV_vertex_program =
      glad_gl_has_extension(exts, exts_i, "GL_NV_vertex_program");
  GLAD_GL_NV_vertex_program1_1 =
      glad_gl_has_extension(exts, exts_i, "GL_NV_vertex_program1_1");
  GLAD_GL_NV_vertex_program2 =
      glad_gl_has_extension(exts, exts_i, "GL_NV_vertex_program2");
  ...
  GLAD_GL_NV_vertex_program3 =
      glad_gl_has_extension(exts, exts_i, "GL_NV_vertex_program3");
  GLAD_GL_NV_vertex_program4 =
      glad_gl_has_extension(exts, exts_i, "GL_NV_vertex_program4");
  GLAD_GL_NV_video_capture =
      glad_gl_has_extension(exts, exts_i, "GL_NV_video_capture");
  GLAD_GL_NV_viewport_array2 =
      glad_gl_has_extension(exts, exts_i, "GL_NV_viewport_array2");
  GLAD_GL_NV_viewport_swizzle =
      glad_gl_has_extension(exts, exts_i, "GL_NV_viewport_swizzle");
  GLAD_GL_OES_byte_coordinates =
      glad_gl_has_extension(exts, exts_i, "GL_OES_byte_coordinates");
  GLAD_GL_OES_compressed_paletted_texture =
      glad_gl_has_extension(exts, exts_i, "GL_OES_compressed_paletted_texture");
  GLAD_GL_OES_fixed_point =
      glad_gl_has_extension(exts, exts_i, "GL_OES_fixed_point");
  GLAD_GL_OES_query_matrix =
      glad_gl_has_extension(exts, exts_i, "GL_OES_query_matrix");
  GLAD_GL_OES_read_format =
      glad_gl_has_extension(exts, exts_i, "GL_OES_read_format");
  GLAD_GL_OES_single_precision =
      glad_gl_has_extension(exts, exts_i, "GL_OES_single_precision");
  GLAD_GL_OML_interlace =
      glad_gl_has_extension(exts, exts_i, "GL_OML_interlace");
  GLAD_GL_OML_resample = glad_gl_has_extension(exts, exts_i, "GL_OML_resample");
  GLAD_GL_OML_subsample =
      glad_gl_has_extension(exts, exts_i, "GL_OML_subsample");
  GLAD_GL_OVR_multiview =
      glad_gl_has_extension(exts, exts_i, "GL_OVR_multiview");
  GLAD_GL_OVR_multiview2 =
      glad_gl_has_extension(exts, exts_i, "GL_OVR_multiview2");
  GLAD_GL_PGI_misc_hints =
      glad_gl_has_extension(exts, exts_i, "GL_PGI_misc_hints");
  GLAD_GL_PGI_vertex_hints =
      glad_gl_has_extension(exts, exts_i, "GL_PGI_vertex_hints");
  GLAD_GL_REND_screen_coordinates =
      glad_gl_has_extension(exts, exts_i, "GL_REND_screen_coordinates");
  GLAD_GL_S3_s3tc = glad_gl_has_extension(exts, exts_i, "GL_S3_s3tc");
  GLAD_GL_SGIS_detail_texture =
      glad_gl_has_extension(exts, exts_i, "GL_SGIS_detail_texture");
  GLAD_GL_SGIS_fog_function =
      glad_gl_has_extension(exts, exts_i, "GL_SGIS_fog_function");
  GLAD_GL_SGIS_generate_mipmap =
      glad_gl_has_extension(exts, exts_i, "GL_SGIS_generate_mipmap");
  GLAD_GL_SGIS_multisample =
      glad_gl_has_extension(exts, exts_i, "GL_SGIS_multisample");
  GLAD_GL_SGIS_pixel_texture =
      glad_gl_has_extension(exts, exts_i, "GL_SGIS_pixel_texture");
  GLAD_GL_SGIS_point_line_texgen =
      glad_gl_has_extension(exts, exts_i, "GL_SGIS_point_line_texgen");
  GLAD_GL_SGIS_point_parameters =
      glad_gl_has_extension(exts, exts_i, "GL_SGIS_point_parameters");
  GLAD_GL_SGIS_sharpen_texture =
      glad_gl_has_extension(exts, exts_i, "GL_SGIS_sharpen_texture");
  GLAD_GL_SGIS_texture4D =
      glad_gl_has_extension(exts, exts_i, "GL_SGIS_texture4D");
  GLAD_GL_SGIS_texture_border_clamp =
      glad_gl_has_extension(exts, exts_i, "GL_SGIS_texture_border_clamp");
  GLAD_GL_SGIS_texture_color_mask =
      glad_gl_has_extension(exts, exts_i, "GL_SGIS_texture_color_mask");
  GLAD_GL_SGIS_texture_edge_clamp =
      glad_gl_has_extension(exts, exts_i, "GL_SGIS_texture_edge_clamp");
  GLAD_GL_SGIS_texture_filter4 =
      glad_gl_has_extension(exts, exts_i, "GL_SGIS_texture_filter4");
  GLAD_GL_SGIS_texture_lod =
      glad_gl_has_extension(exts, exts_i, "GL_SGIS_texture_lod");
  GLAD_GL_SGIS_texture_select =
      glad_gl_has_extension(exts, exts_i, "GL_SGIS_texture_select");
  GLAD_GL_SGIX_async = glad_gl_has_extension(exts, exts_i, "GL_SGIX_async");
  GLAD_GL_SGIX_async_histogram =
      glad_gl_has_extension(exts, exts_i, "GL_SGIX_async_histogram");
  GLAD_GL_SGIX_async_pixel =
      glad_gl_has_extension(exts, exts_i, "GL_SGIX_async_pixel");
  GLAD_GL_SGIX_blend_alpha_minmax =
      glad_gl_has_extension(exts, exts_i, "GL_SGIX_blend_alpha_minmax");
  GLAD_GL_SGIX_calligraphic_fragment =
      glad_gl_has_extension(exts, exts_i, "GL_SGIX_calligraphic_fragment");
  GLAD_GL_SGIX_clipmap = glad_gl_has_extension(exts, exts_i, "GL_SGIX_clipmap");
  GLAD_GL_SGIX_convolution_accuracy =
      glad_gl_has_extension(exts, exts_i, "GL_SGIX_convolution_accuracy");
  GLAD_GL_SGIX_depth_pass_instrument =
      glad_gl_has_extension(exts, exts_i, "GL_SGIX_depth_pass_instrument");
  GLAD_GL_SGIX_depth_texture =
      glad_gl_has_extension(exts, exts_i, "GL_SGIX_depth_texture");
  GLAD_GL_SGIX_flush_raster =
      glad_gl_has_extension(exts, exts_i, "GL_SGIX_flush_raster");
  GLAD_GL_SGIX_fog_offset =
      glad_gl_has_extension(exts, exts_i, "GL_SGIX_fog_offset");
  GLAD_GL_SGIX_fragment_lighting =
      glad_gl_has_extension(exts, exts_i, "GL_SGIX_fragment_lighting");
  GLAD_GL_SGIX_framezoom =
      glad_gl_has_extension(exts, exts_i, "GL_SGIX_framezoom");
  GLAD_GL_SGIX_igloo_interface =
      glad_gl_has_extension(exts, exts_i, "GL_SGIX_igloo_interface");
  GLAD_GL_SGIX_instruments =
      glad_gl_has_extension(exts, exts_i, "GL_SGIX_instruments");
  GLAD_GL_SGIX_interlace =
      glad_gl_has_extension(exts, exts_i, "GL_SGIX_interlace");
  GLAD_GL_SGIX_ir_instrument1 =
      glad_gl_has_extension(exts, exts_i, "GL_SGIX_ir_instrument1");
  GLAD_GL_SGIX_list_priority =
      glad_gl_has_extension(exts, exts_i, "GL_SGIX_list_priority");
  GLAD_GL_SGIX_pixel_texture =
      glad_gl_has_extension(exts, exts_i, "GL_SGIX_pixel_texture");
  GLAD_GL_SGIX_pixel_tiles =
      glad_gl_has_extension(exts, exts_i, "GL_SGIX_pixel_tiles");
  GLAD_GL_SGIX_polynomial_ffd =
      glad_gl_has_extension(exts, exts_i, "GL_SGIX_polynomial_ffd");
  GLAD_GL_SGIX_reference_plane =
      glad_gl_has_extension(exts, exts_i, "GL_SGIX_reference_plane");
  GLAD_GL_SGIX_resample =
      glad_gl_has_extension(exts, exts_i, "GL_SGIX_resample");
  GLAD_GL_SGIX_scalebias_hint =
      glad_gl_has_extension(exts, exts_i, "GL_SGIX_scalebias_hint");
  GLAD_GL_SGIX_shadow = glad_gl_has_extension(exts, exts_i, "GL_SGIX_shadow");
  GLAD_GL_SGIX_shadow_ambient =
      glad_gl_has_extension(exts, exts_i, "GL_SGIX_shadow_ambient");
  GLAD_GL_SGIX_sprite = glad_gl_has_extension(exts, exts_i, "GL_SGIX_sprite");
  GLAD_GL_SGIX_subsample =
      glad_gl_has_extension(exts, exts_i, "GL_SGIX_subsample");
  GLAD_GL_SGIX_tag_sample_buffer =
      glad_gl_has_extension(exts, exts_i, "GL_SGIX_tag_sample_buffer");
  GLAD_GL_SGIX_texture_add_env =
      glad_gl_has_extension(exts, exts_i, "GL_SGIX_texture_add_env");
  ...
  GLAD_GL_SGIX_texture_lod_bias =
      glad_gl_has_extension(exts, exts_i, "GL_SGIX_texture_lod_bias");
  GLAD_GL_SGIX_texture_multi_buffer =
      glad_gl_has_extension(exts, exts_i, "GL_SGIX_texture_multi_buffer");
  GLAD_GL_SGIX_texture_scale_bias =
      glad_gl_has_extension(exts, exts_i, "GL_SGIX_texture_scale_bias");
  GLAD_GL_SGIX_vertex_preclip =
      glad_gl_has_extension(exts, exts_i, "GL_SGIX_vertex_preclip");
  GLAD_GL_SGIX_ycrcb = glad_gl_has_extension(exts, exts_i, "GL_SGIX_ycrcb");
  GLAD_GL_SGIX_ycrcb_subsample =
      glad_gl_has_extension(exts, exts_i, "GL_SGIX_ycrcb_subsample");
  GLAD_GL_SGIX_ycrcba = glad_gl_has_extension(exts, exts_i, "GL_SGIX_ycrcba");
  GLAD_GL_SGI_color_matrix =
      glad_gl_has_extension(exts, exts_i, "GL_SGI_color_matrix");
  GLAD_GL_SGI_color_table =
      glad_gl_has_extension(exts, exts_i, "GL_SGI_color_table");
  GLAD_GL_SGI_texture_color_table =
      glad_gl_has_extension(exts, exts_i, "GL_SGI_texture_color_table");
  GLAD_GL_SUNX_constant_data =
      glad_gl_has_extension(exts, exts_i, "GL_SUNX_constant_data");
  GLAD_GL_SUN_convolution_border_modes =
      glad_gl_has_extension(exts, exts_i, "GL_SUN_convolution_border_modes");
  GLAD_GL_SUN_global_alpha =
      glad_gl_has_extension(exts, exts_i, "GL_SUN_global_alpha");
  GLAD_GL_SUN_mesh_array =
      glad_gl_has_extension(exts, exts_i, "GL_SUN_mesh_array");
  GLAD_GL_SUN_slice_accum =
      glad_gl_has_extension(exts, exts_i, "GL_SUN_slice_accum");
  GLAD_GL_SUN_triangle_list =
      glad_gl_has_extension(exts, exts_i, "GL_SUN_triangle_list");
  GLAD_GL_SUN_vertex = glad_gl_has_extension(exts, exts_i, "GL_SUN_vertex");
  GLAD_GL_WIN_phong_shading =
      glad_gl_has_extension(exts, exts_i, "GL_WIN_phong_shading");
  GLAD_GL_WIN_specular_fog =
      glad_gl_has_extension(exts, exts_i, "GL_WIN_specular_fog");
